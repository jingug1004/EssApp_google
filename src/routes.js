...
import CompletionCertificateListPage from '@/pages/CompletionCertificateList.vue';
import CompletionCertificatePage from '@/pages/CompletionCertificate.vue';
import LoadingPage from '@/pages/loading.vue';
import PopupPDFPage from '@/pages/popup-pdf.vue';
import EventPage from '@/pages/popup-event.vue';
...
export default [
  ...
  //   path: '/dynamic-route/blog/:blogId/post/:postId/', component: DynamicRoutePage,
    ...
    path: '/CompCertList', component: CompletionCertificateListPage,
  },{
    path: '/CompCert', component: CompletionCertificatePage,
  },{
    path: '/loading', component: LoadingPage,
  },{
    path: '/pdf/:cid', component: PopupPDFPage,
  },{
    path: '/event/:popupid', component: EventPage,
  },{
